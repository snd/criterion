...
var beget, comparisonNameToOperatorMapping, criterionFactory, explodeObject, factories, flatten, getSqlFragmentParams, identity, implementsSqlFragmentInterface, isEmptyArray, isNegation, modifierFactories, name, operator, prototypes, some, subqueryNameToOperatorMapping, _fn, _fn1,
  __slice = [].slice;
...
implementsSqlFragmentInterface = function(value) {
  return (value != null) && 'function' === typeof value.sql;
};

getSqlFragmentParams = function(fragment) {
...
_fn1 = function(name, operator) {
  return modifierFactories[name] = function(key, value) {
    console.log('subquery factory called:', {
      name: name,
      operator: operator,
      key: key,
      value: value
