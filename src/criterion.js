...
var beget, comparisonNameToOperatorMapping, criterionFactory, explodeObject, factories, flatten, helper, identity, implementsSqlFragmentInterface, internals, isEmptyArray, isNegation, modifierFactories, name, operator, prototypes, some, subqueryNameToOperatorMapping, _fn, _fn1,
  __slice = [].slice;
...
factories.rawSql = helper.rawSql = function(sql, params) {
  if (params == null) {
    params = [];
  }
