...
var beget, comparisonNameToOperatorMapping, explodeObject, factories, flatten, identity, isEmptyArray, isNegation, isSqlFragment, mainFactory, modifierFactories, name, operator, prototypes, some, subqueryNameToOperatorMapping, _fn, _fn1,
  __slice = [].slice;
...
factories.sqlFragment = function(sql, params) {
  return beget(prototypes.sqlFragment, {
    _sql: sql,
    _params: params
  });
};
