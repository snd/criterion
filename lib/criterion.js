...
var comparisonTable, criterion, dsl, explodeObject, helper, implementsSqlFragmentInterface, isAnd, isEmptyArray, isNegation, isOr, key, modifiers, normalizeParams, normalizeSql, prototypes, rawSql, some, value, _, _fn,
  __slice = [].slice;
...
rawSql = function(sql, params) {
  ...
  return _.create(prototypes.rawSql, {
    _sql: sql,
    _params: params
  });
};
...
dsl.escape = function(sql) {
  return _.create(prototypes.escape, {
    _sql: sql
  });
};
...
dsl.wrap = function(sql) {
  return _.create(prototypes.wrap, {
    _sql: sql
  });
};
...
dsl.compare = function(operator, left, right) {
  return _.create(prototypes.comparison, {
    _left: left,
    _right: right,
    _operator: operator
  });
...
dsl["null"] = modifiers.$null = function(operand, isNull) {
  ...
  return _.create(prototypes["null"], {
    _operand: operand,
    _isNull: isNull
  });
};
...
dsl.not = function(inner) {
  ...
  return _.create(prototypes.not, {
    _inner: inner
  });
};
...
dsl.exists = function(operand) {
  ...
  return _.create(prototypes.exists, {
    _operand: operand
  });
};
...
dsl.subquery = function(operator, left, right) {
  return _.create(prototypes.subquery, {
    _left: left,
    _right: right,
    _operator: operator
  });
...
dsl.and = function() {
  ...
  return _.create(prototypes.and, {
    _operands: operands
  });
};
